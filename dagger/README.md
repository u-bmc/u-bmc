...
- Status and backlog are tracked centrally in [docs/roadmap.md](../docs/roadmap.md).
- Platform enablement details and non-userspace prerequisites (kernel, DT, udev, hwmon, pinmux, watchdog) are also tracked in [docs/roadmap.md](../docs/roadmap.md).
- For porting guidance and how the builder will integrate with targets, see [docs/porting.md](../docs/porting.md).
