...
func (s *StateMgr) createManagementControllerStateMachine(controllerName string) (*state.Machine, error) {
	sm, err := state.NewStateMachine(
		...
		state.WithActionTransition(
			...
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_ENABLE),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_NOT_READY.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_REBOOT.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_REBOOT),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_NOT_READY.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_WARM_RESET.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_WARM_RESET),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_NOT_READY.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_COLD_RESET.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_COLD_RESET),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_NOT_READY.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_HARD_RESET.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_HARD_RESET),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_NOT_READY.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_FACTORY_RESET.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_FACTORY_RESET),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_DISABLED.String(),
			schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_DISABLE.String(),
			s.createManagementControllerTransitionAction(controllerName, schemav1alpha1.ManagementControllerAction_MANAGEMENT_CONTROLLER_ACTION_DISABLE),
		),
		state.WithActionTransition(
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_DISABLED.String(),
			schemav1alpha1.ManagementControllerStatus_MANAGEMENT_CONTROLLER_STATUS_READY.String(),
		...
		state.WithStateEntry(s.createManagementControllerStatusEntryCallback(controllerName)),
		state.WithStateExit(s.createManagementControllerStatusExitCallback(controllerName)),
		state.WithPersistence(s.createManagementControllerPersistenceCallback(controllerName)),
		state.WithBroadcast(s.createManagementControllerBroadcastCallback(controllerName)),
	)
...
func (s *StateMgr) createManagementControllerStatusEntryCallback(controllerName string) state.StateEntryCallback {
	return func(machineName, stateName string) error {
		if s.logger != nil {
			s.logger.Info("Management Controller entering status",
...
func (s *StateMgr) createManagementControllerStatusExitCallback(controllerName string) state.StateExitCallback {
	return func(machineName, stateName string) error {
		if s.logger != nil {
			s.logger.Info("Management Controller exiting status",
				"controller_name", controllerName,
				"status", stateName)
		}
		return nil
...
func (s *StateMgr) createManagementControllerTransitionAction(controllerName string, action schemav1alpha1.ManagementControllerAction) state.ActionFunc {
	return func(from, to, trigger string) error {
		if s.logger != nil {
			s.logger.Info("Management Controller state transition",
				"controller_name", controllerName,
				"from", from,
				"to", to,
...
func (s *StateMgr) createManagementControllerPersistenceCallback(controllerName string) state.PersistenceCallback {
...
func (s *StateMgr) createManagementControllerBroadcastCallback(componentName string) state.BroadcastCallback {
