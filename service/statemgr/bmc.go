...
func (s *StateMgr) createManagementControllerStatusEntryCallback(controllerName string) state.EntryCallback {
...
func (s *StateMgr) createManagementControllerStatusExitCallback(controllerName string) state.ExitCallback {
	return func(machineName, stateName string) error {
		if s.logger != nil {
